...
const HeroSection = () => {
  return (
    <section className='wrapper pt-15 mb-10 md:mb-16'>
        <div className="library-hero-card">
            <div className="library-hero-content">
                <div className="library-hero-text">
                    <h1 className='library-hero-title text-4xl font-serif font-bold'>Your Library</h1>
                    <p className='library-hero-description'>Convert your Books into Interactive AI Conversations. <br className='hidden md:block'/> 
                ...
                <div className="library-hero-illustration-desktop">
                    <Image src="/assets/hero-illustration.png" alt='hero-illustration' width={400} height={400} className='object-contain'></Image>
                </div>

                <div className="library-hero-illustration">
                    <Image src="/assets/hero-illustration.png" alt='hero-illustration' width={300} height={300} className='object-contain'></Image>
                </div>

                <div className="library-steps-card min-w-[250px] max-w-[280px] z-10 shadow-soft-md">
